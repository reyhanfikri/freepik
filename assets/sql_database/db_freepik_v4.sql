...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2018 at 04:33 AM
...
(1, 2, 1, 'perfectly-timed-funny-cat-pictures-5', 'perfectly-timed-funny-cat-pictures-5.jpg', 10000, 200000),
(2, 2, 1, 'perfectly-timed-funny-cat-pictures-6', 'perfectly-timed-funny-cat-pictures-6.jpg', 5000, 10000);
...
--
ALTER TABLE `t_user_profile`
  MODIFY `id_user_profile` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
