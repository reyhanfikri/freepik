...
(1, 2, 1, 'cute_kitten', 'cute_kitten.jpg', 3, 91),
(2, 2, 1, 'perfectly-timed-funny-cat-pictures-5', 'perfectly-timed-funny-cat-pictures-5.jpg', 0, 39),
(3, 2, 1, 'fantasy_background', 'fantasy_background.jpg', 0, 9),
(4, 2, 1, 'cat', 'cat.jpg', 0, 4),
(5, 2, 1, 'blue', 'blue.jpg', 0, 6),
(6, 2, 1, 'mobil_kaca', 'mobil_kaca.jpg', 0, 8),
(7, 2, 1, 'tipsskripsi', 'tipsskripsi.jpg', 0, 2),
(8, 4, 1, 'fujisan-fumotoppara-campground-reflection-70684195', 'fujisan-fumotoppara-campground-reflection-70684195.jpg', 1, 9),
...
(1, 2, 'Reyhan Fikri', 'Laki-laki', 'Komplek GBA 1 Blok i . 66	                        '),
(2, 3, NULL, NULL, NULL),
(3, 4, NULL, NULL, NULL),
...
--
ALTER TABLE `t_user_profile`
  MODIFY `id_user_profile` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
